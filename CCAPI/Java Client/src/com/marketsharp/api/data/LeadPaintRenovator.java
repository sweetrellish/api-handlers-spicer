...
*
*/
public class LeadPaintRenovator {
    ...
    private String zip;
    private List<LeadPaintToRenovator> leadPaint;
     ...
     */
    public LeadPaintRenovator(String id) {
        this();
        this.id = id;
    }
    ...
    */
   public List<LeadPaintToRenovator> getLeadPaint() {
      return leadPaint;
   }
    ...
    */
   public void setLeadPaint(List<LeadPaintToRenovator> leadPaint) {
